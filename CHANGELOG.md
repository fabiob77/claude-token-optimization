...
- Initial release of the optimization guide. Covers Claude.ai (Free / Pro / Max / Team / Enterprise), the Claude API, Claude Code, Claude Desktop (Cowork), and Claude in Chrome.
- Pricing tables for Opus 4.7, Opus 4.6, Sonnet 4.6, Sonnet 4.5, Haiku 4.5, and legacy models.
- Subscription plan comparison and a feature cost-impact reference.
